...
values
  ('00000000-0000-0000-0000-000000000001', 'Vernissage — Lignes de fuite',
   ...
   'vernissage', null, 'Peinture', 'Paris', 'Belleville', '2026-07-24T17:00:00Z', 'Galerie du Marais Est',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000002', 'Open call — Résidence d''été',
   ...
   'open_call', null, 'Multidisciplinaire', 'Paris', 'Montreuil', '2026-07-31T22:00:00Z', 'Candidature en ligne',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000003', 'Workshop — Taille directe sur pierre',
   ...
   'workshop', null, 'Sculpture', 'Paris', 'Pantin', '2026-07-27T08:00:00Z', 'Atelier des Grands Voisins',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000004', 'Annonce — Chevalet à donner',
   ...
   'annonce', 'materiel', 'Peinture', 'Paris', 'Belleville', '2026-07-19T22:00:00Z', 'Belleville',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000005', 'Performance — Corps et mémoire',
   ...
   'expo', null, 'Performance', 'Paris', 'Bastille', '2026-08-05T18:30:00Z', 'La Compagnie',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000006', 'Vernissage — Σκιές (Ombres)',
   ...
   'vernissage', null, 'Peinture', 'Athènes', 'Psyrri', '2026-07-23T16:30:00Z', 'Galerie Kolonaki Sud',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000007', 'Atelier partagé — Places disponibles',
   ...
   'annonce', 'atelier', 'Sculpture', 'Athènes', 'Metaxourgeio', '2026-07-18T21:00:00Z', 'Metaxourgeio',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000008', 'Expo collective — Nouvelle scène athénienne',
   ...
   'expo', null, 'Multidisciplinaire', 'Athènes', 'Exarcheia', '2026-08-10T15:00:00Z', 'Espace Exarcheia',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000009', 'Workshop — Écriture scénique et performance',
   ...
   'workshop', null, 'Performance', 'Athènes', 'Koukaki', '2026-08-02T06:00:00Z', 'Studio Koukaki',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000010', 'Open call — Biennale des matériaux recyclés',
   ...
   'open_call', null, 'Sculpture', 'Athènes', 'Gazi', '2026-08-14T21:00:00Z', 'Candidature en ligne',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000011', 'Annonce — Recherche modèle vivant',
   ...
   'annonce', 'oeuvre', 'Peinture', 'Paris', 'Belleville', '2026-07-20T22:00:00Z', 'Atelier Belleville',
   'publie', null, 'manuel'),
  ...
  ('00000000-0000-0000-0000-000000000012', 'Vernissage — Matière première',
   ...
   'vernissage', null, 'Sculpture', 'Paris', 'Montreuil', '2026-07-31T17:00:00Z', 'Fabrique Montreuil',
   'publie', null, 'manuel')
